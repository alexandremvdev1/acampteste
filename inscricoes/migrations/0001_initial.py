# Generated by Django 5.2.3 on 2025-08-08 11:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('informacoes_extras', models.TextField(blank=True, null=True, verbose_name='Informações extras (qualquer detalhe relevante não coberto acima)')),
                ('inscricao', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='inscricoes.inscricao')),
